...
The prototype is live, tested, and open: 8 official U.S. legal sources, 650+ indexed passages, 32 evaluation questions with 100% retrieval accuracy, a working mobile interface, and a clear path to multi-jurisdiction expansion.
...
User question
    ||
    vv
[TF-IDF Retrieval] - searches 650+ passages from 8 official sources
    ||
    vv
...
- [x] Offline retrieval pipeline with 8 official sources
